...
def media_player(video_path):
    ...
    class SMPWindow(QMainWindow):
        def __init__(self, parent=None):
            ...
            self.setWindowIcon(QIcon("assets/smp.ico"))
            ...
            self.replay_button.setIcon(QIcon("assets/replay_10_black_48dp.svg"))
            ...
            self.play_pause_button.setIcon(QIcon("assets/play_arrow_black_48dp.svg"))
            ...
            self.forward_button.setIcon(QIcon("assets/forward_30_black_48dp.svg"))
            ...
            self.volume_button.setIcon(QIcon("assets/volume_up_black_48dp.svg"))
            ...
            self.full_screen_button.setIcon(QIcon("assets/fullscreen_black_48dp.svg"))
            ...
            ################################# MARCHER SUPER, bien mais rend inutilisable les boutons.... ???
            self.play(f'{video_path}')
        ...
        def mediaStateChanged(self):
            if self.media_player.state() == QMediaPlayer.PlayingState:
                self.play_pause_button.setIcon(QIcon("assets/pause_black_48dp.svg"))
            else:
                self.play_pause_button.setIcon(QIcon("assets/play_arrow_black_48dp.svg"))
        ...
        def adjustVolumeIcon(self):
            ...
            if vol >= 70:
                ...
                self.volume_button.setIcon(QIcon("assets/volume_down_black_48dp.svg"))

            else:
                self.volume_button.setIcon(QIcon("assets/volume_mute_black_48dp.svg"))
        ...
        def showAboutDialog():
            ...
            msg_box.setWindowIcon(QIcon("assets/smp.png"))
        ...
        def contextMenuEvent(self, event):
            ...
            action_full_screen = context_menu.addAction(QIcon("assets/fullscreen_black_48dp.svg"), "Full Screen\tF")
            action_quit = context_menu.addAction(QIcon("assets/close_black_48dp.svg"), "Exit\tCtrl+X")
            if self.windowState() == Qt.WindowFullScreen:
                context_menu.hide()
                return
    ...
    if __name__ == "__main__":
        ...
        QFontDatabase.addApplicationFont("app_pc_papyV2/media_player/assets/Roboto-Regular.ttf")
...
media_player('/Users/macminithomasconstantin/Downloads/LA HONTE IL SAIT PAS CONDUIRE LE GROS NULLOS (Expeditions MudRunner).mp4')
